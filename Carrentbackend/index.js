...
const carmodel = require("./model/Itemdetails");
...
app.post('/newcar',(request,response)=>{
    console.log(request.body)
    new carmodel(request.body).save();
...
//     response.send("Data uploaded")
// })
app.post('/newcar',upload.single('image1'),async (request,response) => {
    try {
